...
class K8sJobManager:
    ...
    def create_build_job(self, job_id: str, registry_url: str = "registry.digitalocean.com/automlops"):
        ...
        # Load job template
        template_path = Path(__file__).parent.parent.parent.parent / "k8s-manifests" / "build" / "kaniko-build-job-template.yaml"
